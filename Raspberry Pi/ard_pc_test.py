...
class Main(threading.Thread):
    def __init__(self):
        ...
        #for testing of explore
        self.pc_thread.test_send()
	time.sleep(1)
	self.pc_thread.send_data()
	print("Sent sensor data to algo")
    ...
    def read_from_pc(self):
        while True:
            ...
            print("Message Received from PC: {}".format(read_pc_msg))
            lol = read_pc_msg.split("|")
            print("Sending message to Arduino: {}".format(lol[3]))
            self.write_to_arduino(lol[3])
